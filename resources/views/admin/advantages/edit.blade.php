...
<body>
    <h1>Ma'lumot ID:{{$advantages->id}}</h1>
     <form action="{{ route('advantages.update', $advantages->id) }}" method="POST" enctype="multipart/form-data">
       ...
       <div class="form-group">
        ...
        <input type="file" name="image" class="form-control" value="{{$advantages->image}}">
       </div>
       <div class="form-group">
          <input type="submit" name="s1" value="Yangilash" class="btn btn-primary">   
      </div>  
     </form>
</body>
</html>
